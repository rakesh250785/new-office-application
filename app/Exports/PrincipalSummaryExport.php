...
class PrincipalSummaryExport extends DefaultValueBinder implements FromCollection, ShouldQueue, WithChunkReading, WithColumnFormatting, WithCustomValueBinder, WithHeadings, WithMapping
{
    use Exportable;
